const CV = () => {
  return (
    <div className="w-full flex flex-row justify-center md:justify-start md:pl-5 gap-5">
      <a href="/saksit-website/Saksit_CV.pdf" download="Saksit_CV.pdf" target="_blank" rel="noopener noreferrer">
      ...
      <a href="/saksit-website/Saksit_CV.pdf" target="_blank" rel="noopener noreferrer">
